...
import { ChartPieIcon, PlusCircleIcon, CogIcon, BanknotesIcon, BriefcaseIcon, HistoryIcon } from './components/Icons';
import { useLanguage } from './context/LanguageContext';

type Tab = 'dashboard' | 'add' | 'budget' | 'accounts' | 'investments' | 'history';
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-gray-100 flex flex-col">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-gray-800 border-t border-gray-700 flex justify-around shadow-lg">
        ...
        <NavItem tab="budget" icon={<CogIcon />} label={t('nav.budget')} />
