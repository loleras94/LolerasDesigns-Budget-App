        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-gray-800 p-4 rounded-lg shadow-md text-center">
                    <p className="text-sm text-gray-400">{t('dashboard.monthlyIncome')}</p>
                    <p className="text-2xl font-semibold text-green-400">€{totalIncome.toFixed(2)}</p>
                </div>
                <div className="bg-gray-800 p-4 rounded-lg shadow-md text-center">
                    <p className="text-sm text-gray-400">{t('dashboard.monthlySpent')}</p>
                    <p className="text-2xl font-semibold text-red-400">€{totalSpending.toFixed(2)}</p>
                </div>
                <div className="bg-gray-800 p-4 rounded-lg shadow-md text-center">
                    <p className="text-sm text-gray-400">{t('dashboard.netSavings')}</p>
                    <p className="text-2xl font-semibold text-blue-400">€{savings.toFixed(2)}</p>
                </div>
            </div>
